...
public class DebugTrip{
   ...
   public DebugTrip(String destination, String departure){
      this(destination, departure, DEFAULT_MODE);  // Initially attempted to call two constructors.
                                                   // Fixed: now calls the 3-argument constructor, assigning a default transport mode.
   }  
