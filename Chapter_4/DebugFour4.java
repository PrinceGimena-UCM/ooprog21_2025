...
public class DebugFour4{
   public static void main(String args[]){
      ...
      DebugTrip trip1;
      DebugTrip trip2;
      DebugTrip trip3; // Fixed: renamed duplicate variable from trip2 to trip3
   ...
   public static void display(DebugTrip trip){
      ...
      System.out.println(" Leaving from " + trip.getDepartureCity()); // Fixed: corrected typo from "trp.getDepartureCity()" to "trip.getDepartureCity()"
