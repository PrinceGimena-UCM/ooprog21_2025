...
public class DebugFour2{
   public static void main(String args[]){
      ...
      pen1 = new DebugPen();
      pen2 = new DebugPen(color, point); // Fixed: parameter order corrected to (color, point) instead of (point, color)
      System.out.println("Default value pen:");
      display(pen1);
      System.out.println("User value pen:");
      display(pen2); // Fixed: corrected typo from "pen22" to "pen2"
   }

   public static void display(DebugPen p){ // Fixed: corrected class name to "DebugPen" (was "FixDebugPen")   
